...
RSpec.describe GroupsController, type: :controller do
    ...
    it "cant create a group (key is nil)" do 
        create_admin(userthree)
        sign_in(userthree)
        post :create, params: {group: {teacher: teacher, course: course, name: "group", key: nil}}
    ...
    it "update a group" do 
        ...
        sign_in(userthree)
        put :update, params: {id: group.id, group: {teacher: teacher, course: course, name: 'test', key: "key", activ: "0"}}
